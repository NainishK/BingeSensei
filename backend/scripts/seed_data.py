...
def seed_data():
    ...
    try:
        ...
        services_data = [
            ...
            {"name": "Netflix", "country": "CA", "domain": "netflix.com", "category": "OTT", "plans": [{"name": "Standard with ads", "cost": 5.99, "currency": "CAD", "country": "CA", "billing_cycle": "monthly"}, {"name": "Standard", "cost": 16.49, "currency": "CAD", "country": "CA", "billing_cycle": "monthly"}]},
            # OTHER
            ...
            {"name": "Kayo Sports", "country": "AU", "domain": "kayosports.com.au", "category": "OTT", "plans": [{"name": "One", "cost": 25.00, "currency": "AUD", "country": "AU", "billing_cycle": "monthly"}]},
            # OTHER
        ...
        db.commit()
        print("Seed data inserted successfully for ALL 16 supported countries (OTT & Full Non-OTT)!")
